        ...
        <div className="order-2 md:order-1 w-full md:w-1/2 mt-32 md:mt-32">
          <div className="space-y-12 ">
            <h1 className="text-4xl font-bold">
              ...
              <span className="text-green-500">Books Website</span>
            </h1>
            <p className="text-xl">
              You to explore the reading and interesting thing in this website
          ...
          <button className="btn mt-6 btn-active btn-primary">
            Secondary
          </button>
        </div>
